...
feePaid = S.nextLong();System.out.print("Enter number of subjects: ");
noSub = S.nextInt();
...
double percentage=(attend/total)*100;
System.out.println("There is shortage of attendance."+percentage);
} else
